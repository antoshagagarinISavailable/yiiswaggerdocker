    ...
    <div class="site-index">
        ...
        <div class="body-content">
            ...
            <?php foreach ($arr as $animal) : ?>
                <div class="card mb-3 border-0" style="">
                    <div class="row g-0">
                        ...
                        <div class="col-md-2">
                            <div class="card-body">
                                <h5 class="card-title mb-4">instance of <?= $animal::class ?></h5>
                                <p class="card-text">
                                    name:
                                    <span>
                                        <?= $animal->getName() ?>
            ...
            <?php endforeach; ?>
            <div class="row">
                <p class="display-2 col-md-4">
                    total creature count: <?= Animals::$countCreatures ?>
                </p>
                <div class="col-md-8">
                    <?php
                    // $var = new Animals();
            ...
            <div class="row">
                <p class="display-2 col-md-4">
                    total MAMALS count: <?= Mamal::$mamalCount ?>
                </p>
                <div class="col-md-8">
                    <?php
                    // $var = new Animals();
            ...
            <div class="row">
                <p class="display-2 col-md-4">
                    total BIRD count: <?= Bird::$birdCound ?>
                </p>
                <div class="col-md-8">
                    <?php
                    // $var = new Animals();
